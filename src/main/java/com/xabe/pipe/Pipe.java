...
public class Pipe<FROM, TO> implements Function<FROM, TO> {
  ...
  /**
   * Here comes the funny part -- adding new function to the Pipe returns new Pipe instance with the target type set to the target type of
   * the function. Internal function wraps previous Pipe and the new function.
   */
