...
public class DateTest {
  ...
  public void shouldGetStartRamadan() throws Exception {
    ...
    this.log(date, hijrahDate);
    this.log(date.minus(1l, ChronoUnit.YEARS), hijrahDate.minus(1, ChronoUnit.YEARS));
  }

  private void log(final LocalDate localDate, final HijrahDate ramadan) {
